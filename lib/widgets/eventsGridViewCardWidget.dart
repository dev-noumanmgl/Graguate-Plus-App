...
class EventsGridViewCardWidgets extends StatelessWidget {
  ...
  const EventsGridViewCardWidgets(
      {super.key,
    ...
    return FutureBuilder<List<EventsModel>>(
      ...
      builder: (context, snapshot) {
        ...
        return GridView.builder(
          ...
          itemCount: events.length, // Number of cards displayed in the grid
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl: currentEventDetails.image,
                            height: 120,
                                        ...
                                        currentEventDetails.like != 0
                                            ? Row(
                                                children: [
                                                  ...
                                                  SizedBox(width: 4.0),
                                                  Text(
                                                    '${currentEventDetails.like}', // Number of likes
                                                    style: TextStyle(
                                                        fontSize: 12.0,
                                                        color: blackColor),
                                                  ),
